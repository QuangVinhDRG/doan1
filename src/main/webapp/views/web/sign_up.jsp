...
<html>
<head>
    <title>R.A Da Nang - Đăng ký khách hàng</title>
...
<div class="h-full bg-[url('../../images/bg_signin.jpg')] bg-no-repeat bg-center bg-cover">
    <div class="bg-black/85 w-[50%] mx-auto relative top-1/2 -translate-y-1/2 py-20">
        <span class="text-[40px] font-bold block text-center text-white relative after:content-[''] after:w-[200px] after:h-[3px] after:bg-[#FFC326] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2">ĐĂNG KÝ</span>
